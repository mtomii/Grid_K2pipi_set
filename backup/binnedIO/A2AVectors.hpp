...
using vobj =  typename FImpl::SiteSpinor;

//template <typename vtype, int NSiteSpinor>
//using SiteSpinorSet = iVector<iVector<iVector<vtype, Nc>, Ns>, NSiteSpinor >;
#if 0
const int NSiteSpinor = 8;
